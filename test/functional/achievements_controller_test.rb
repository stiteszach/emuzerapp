...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { achievement: @achievement.achievement, end_date: @achievement.end_date, resume_id: @achievement.resume_id, start_date: @achievement.start_date }
    end
  ...
  test "should update achievement" do
    put :update, id: @achievement, achievement: { achievement: @achievement.achievement, end_date: @achievement.end_date, resume_id: @achievement.resume_id, start_date: @achievement.start_date }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
